"""
Apache Airflow introduced the TaskFlow API which allow you to create tasks 
using Python decorators (cool) like @task.

This is a cleaner and more intuitive way 
...
with DAG(
    ...
    def multiply_by_two(number):
        new_value = number * 2
        print(f"Multiply by two: {number} x 2 = {new_value}")
        return new_value
